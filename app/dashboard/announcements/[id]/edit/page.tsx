  ...
  const loadData = async () => {
    ...
    if (announcementData) {
      ...
      setFormData({
        ...
        backgroundColor: announcementData.background_color || '#EC4899',
        textColor: announcementData.text_color || '#FFFFFF',
        icon: announcementData.icon || '',
        linkUrl: announcementData.link_url || '',
        isActive: announcementData.is_active ?? true,
      })
    }
  }
  ...
  return (
    <>
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 font-avenir">Editar Aviso</h1>
        <p className="mt-2 text-gray-600">Edite as informações do aviso</p>
      </div>
